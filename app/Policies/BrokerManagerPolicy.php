...
class BrokerManagerPolicy
{
    ...
    {
        return $user->role === 'ROLE_BROKER' && $user->id === $manager->broker_id;
    }
     ...
     */
    public function restore(User $user, User $manager): bool
    {
     ...
     */
    public function forceDelete(User $user, User $manager): bool
    {
        return in_array($user->role, ['ROLE_SUPERUSER', 'ROLE_ADMIN', 'ROLE_BROKER']);
    }
}
